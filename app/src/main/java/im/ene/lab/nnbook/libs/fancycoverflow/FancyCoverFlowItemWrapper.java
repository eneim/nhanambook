...
public class FancyCoverFlowItemWrapper extends ViewGroup {
	...
	private void remeasureChildren() {
		...
		if (child != null) {
			...
			final int originalChildHeight = child.getMeasuredHeight();
			final int originalChildWidth = child.getMeasuredWidth();
			...
			final int childWidth = (int) (this.originalScaledownFactor * originalChildWidth);
