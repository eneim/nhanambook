...
public abstract class FancyCoverFlowAdapter extends BaseAdapter {
	...
	@Override
	public final View getView(final int i, View reusableView,
			ViewGroup viewGroup) {
		final FancyCoverFlow coverFlow = (FancyCoverFlow) viewGroup;
		...
		coverFlowItem
				.setLayoutParams(new FancyCoverFlow.LayoutParams(wrappedView
						.getMeasuredWidth(), wrappedView.getMeasuredHeight()));

		coverFlowItem.requestLayout();
